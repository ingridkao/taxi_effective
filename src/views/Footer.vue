<template>
	<footer id="main_footer">
		<div class="tuicLogo">
			<a target="_blank" href="https://tuic.gov.taipei/">
				<img :src="tuic" :alt="$t('TUIC')">
			</a>
		</div>
		<div>
...
<script>
import tuic from '@/assets/img/tuic_logo.svg'
export default {
	data() {
		return {
			tuic
...
#main_footer {
	...
	.tuicLogo{
		display: flex;
		align-items: center;
		border-right: 1px solid rgba($whiteColor, .6);
		padding-right: 5rem;
		margin-right: 5rem;
		img{
			width: 100%;
