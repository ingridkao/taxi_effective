<template>
    <main id="mapbox_container">
        ...
        <div id="mapboxBox" ref="mapboxBox">
            <div id="beforeMap" class="maps"></div>
            <div id="afterMap" class="maps"></div>
            <!-- <div class="controls">
...
export default {
    ...
    methods: {
        initMapBox(){
            ...
            //     maxZoom: 20
            // })
            const BeforeMapObject = new mapboxgl.Map({
                container: 'beforeMap',
                center: [0,0],
            ...
            const AfterMapObject = new mapboxgl.Map({
                container: 'afterMap',
                center: [0,0],
            ...
            const container = this.$refs.mapboxBox
